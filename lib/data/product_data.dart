  ...
  static final Map<String, List<Product>> _productsByCategory = {
    'phone': [
      Product(
        ...
        price: 1437,
        brand: 'Apple',
        imageUrl: 'assets/images/Apple i phone 14 Pro 128GB Space Black--1693477546.jpg',
      ...
      Product(
        ...
        price: 510,
        brand: 'Apple',
        imageUrl: 'assets/images/apple-iphone-15-128gb-latest-price-in-sri-lanka-3.jpg',
      ...
      Product(
        ...
        price: 899,
        brand: 'Samsung',
        imageUrl: 'assets/images/Galaxy S25.png',
        color: Colors.grey[100],
        category: 'phone',
        rating: 4.6,
      ),
      Product(
        ...
        price: 599,
        brand: 'Google',
        imageUrl: 'assets/images/google pixel 5.jpg',
        color: Colors.grey[200],
        category: 'phone',
        rating: 4.4,
      ),
      Product(
        ...
        price: 699,
        brand: 'Xiaomi',
        imageUrl: 'assets/images/xiaomi 14.jpg',
        color: Colors.grey[100],
        category: 'phone',
        rating: 4.3,
      ),
    ...
    'laptop': [
      Product(
        ...
        price: 2499,
        brand: 'Apple',
        imageUrl: 'assets/images/macbook air m3.jpg',
        color: Colors.grey[100],
        category: 'laptop',
        rating: 4.9,
      ),
      Product(
        ...
        price: 1299,
        brand: 'Dell',
        imageUrl: 'assets/images/dell xps 15.jpg',
        color: Colors.grey[200],
        category: 'laptop',
        rating: 4.5,
      ),
    ...
    'audio': [
      Product(
        ...
        price: 249,
        brand: 'Apple',
        imageUrl: 'assets/images/Audio.png',
        color: Colors.grey[100],
        category: 'audio',
        rating: 4.7,
      ),
      Product(
        ...
        price: 349,
        brand: 'Sony',
        imageUrl: 'assets/images/SONY-WH-1000XM5-1.jpg',
        color: Colors.grey[200],
        category: 'audio',
        rating: 4.8,
      ),
      Product(
        ...
        price: 329,
        brand: 'Bose',
        imageUrl: 'assets/images/Bose-QuietComfort-Ultra-Headphones-4.jpg',
        color: Colors.grey[100],
        category: 'audio',
        rating: 4.6,
      ),
    ...
    'wearables': [
      Product(
        ...
        price: 529,
        brand: 'Apple',
        imageUrl: 'assets/images/Apple-Watch-Ultra-2-49mm-Titanium-GPS-Cellular-1.jpg',
        color: Colors.grey[100],
        category: 'wearables',
        rating: 4.8,
      ),
      Product(
        ...
        price: 329,
        brand: 'Samsung',
        imageUrl: 'assets/images/Samsung-Galaxy-A56-1.jpg',
        color: Colors.grey[200],
        category: 'wearables',
        rating: 4.5,
      ),
      Product(
        ...
        price: 199,
        brand: 'Fitbit',
        imageUrl: 'assets/images/fitbit sense 2.jpg',
        color: Colors.grey[100],
        category: 'wearables',
        rating: 4.2,
      ),
      Product(
        ...
        price: 449,
        brand: 'Garmin',
        imageUrl: 'assets/images/Wearables.png',
        color: Colors.grey[200],
        category: 'wearables',
        rating: 4.6,
      ),
    ...
    'accessories': [
      Product(
        ...
        price: 29,
        brand: 'Apple',
        imageUrl: 'assets/images/usb c charger.jpg',
        color: Colors.grey[100],
      ...
      Product(
        ...
        price: 19,
        brand: 'OtterBox',
        imageUrl: 'assets/images/Phones.png',
        color: Colors.grey[100],
        category: 'accessories',
        rating: 4.5,
      ),
